...
import { platforma } from "@platforma-open/milaboratories.repertoire-diversity-2.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type RepertoireDiversity2BlockContract = BlockContract;
export type RepertoireDiversity2BlockOutputs  = BlockOutputs;
export type RepertoireDiversity2BlockData     = BlockData;
export const RepertoireDiversity2BlockPointer = BlockPointer;
