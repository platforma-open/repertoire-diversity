...
const defaultOptions = computed((): PredefinedGraphOption<"discrete">[] | null => {
  if (!app.model.outputs.pcols) return null;
  ...
  const defaults: PredefinedGraphOption<"discrete">[] = [
    {
      ...
      selectedSource: pcols[getIndex("pl7.app/diversity", pcols)].spec.axesSpec[0],
    },
    {
      inputName: "y",
      selectedSource: pcols[getIndex("pl7.app/diversity", pcols)].spec,
    },
  ];
  return defaults;
});
